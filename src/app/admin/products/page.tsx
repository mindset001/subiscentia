  ...
  return (
    <div className="">
      <div className="flex flex-col md:flex-row justify-between gap-4 mb-6">
        <div>
          <h1 className="text-2xl md:text-3xl font-bold text-[#4C406E] mb-2 font-sackers">Product Management</h1>
          <p className="text-sm md:text-base text-[#4C406E] font-circular">Manage your fragrance catalog and inventory</p>
        </div>
        <button
          className="bg-[#4C406E] h-[50px] text-white px-4 md:px-6 py-2 text-sm md:text-base font-medium flex items-center justify-center gap-2 whitespace-nowrap"
      ...
      <Card className="p-4 md:p-6 shadow-none rounded-none border-none">
        <div className="mb-2">
          <div className="text-base md:text-lg font-semibold text-[#4C406E]">Product Catalog</div>
          <div className="text-xs md:text-sm text-gray-500">{filteredProducts.length} products found</div>
        </div>
          ...
          <table className="min-w-full text-xs md:text-sm">
            <thead>
              <tr className="bg-purple-100 text-[#4C406E]">
                <th className="py-2 px-2 md:px-4 text-left font-medium whitespace-nowrap">Products</th>
                <th className="py-2 px-2 md:px-4 text-left font-medium whitespace-nowrap">Collection</th>
                <th className="py-2 px-2 md:px-4 text-left font-medium whitespace-nowrap">Price</th>
                <th className="py-2 px-2 md:px-4 text-left font-medium whitespace-nowrap">Stock</th>
                ...
                filteredProducts.map((product) => (
                  <tr key={product._id} className="border-b last:border-b-0 hover:bg-gray-50">
                    <td className="py-3 px-2 md:px-4">
                      ...
                      <div className="text-xs text-gray-500 hidden md:block">{product.description.substring(0, 60)}...</div>
                    </td>
                    <td className="py-3 px-2 md:px-4">
                    ...
                    <td className="py-3 px-2 md:px-4 text-xs md:text-sm">${product.price}</td>
                    <td className="py-3 px-2 md:px-4 text-xs md:text-sm">{product.stockQuantity}</td>
                    <td className="py-3 px-2 md:px-4">
                    ...
                    <td className="py-3 px-2 md:px-4">
                      <div className="flex gap-2 md:gap-3">
                        ...
                        >
                          {product.isPublished ? <EyeOff size={16} className="md:w-[18px] md:h-[18px]" /> : <Eye size={16} className="md:w-[18px] md:h-[18px]" />}
                        </button>
                        <button 
                          className="hover:text-purple-700"
