...
const CartHero = () => (
  <section className="relative h-[400px] flex flex-col items-center justify-center overflow-hidden bg-white">
    ...
    <div className="relative z-10 w-full text-center px-4">
      <h1 className="text-[10vw] font-light text-purple-900 mb-6 tracking-wide leading-tight font-sackers">
       Shopping Cart
      </h1>
      <div className="mt-8 flex justify-center">
        <p className="w-[70%] text-xs md:text-[24px] font-light tracking-widest text-gray-700 uppercase font-circular">
